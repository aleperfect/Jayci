...
const handler = async (m, { conn, usedPrefix }) => {
  ...
  ${tradutor.texto1[1]} 𝐉𝐚𝐲𝐜𝐢 𝐁𝐨𝐭
  ${tradutor.texto1[2]} +51961792248
  ${tradutor.texto1[3]} https://www.instagram.com/jayci_18
  ...
  const Message = {
    document: { url: `https://www.instagram.com/jayci_18` },
    ...
    contextInfo: {
      ...
      isForwarded: true,
      externalAdReply: {
        mediaUrl: "https://www.instagram.com/jayci_18",
        mediaType: 2,
        previewType: "pdf",
        title: "𝐉𝐚𝐲𝐜𝐢 𝐁𝐨𝐭",
        body: tradutor.texto2,
        thumbnail: imagen1,
        sourceUrl: "https://www.instagram.com/jayci_18",
      },
    },
    caption: info,
    footer: wm,
